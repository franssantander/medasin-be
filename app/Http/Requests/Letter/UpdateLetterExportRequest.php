...
class UpdateLetterExportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pages.*.cover' => ['nullable', 'array:theme,show_logo,text_alignment,subheader,description_blocks,author_name,date_label,avatar_url,hero_image_url,hero_image_aspect_ratio,hero_image_caption,hero_image_caption_alignment,hero_image_caption_placement,section_order'],
            ...
            'pages.*.cover.hero_image_caption' => ['sometimes', 'nullable', 'string', 'max:120'],
            'pages.*.cover.hero_image_caption_alignment' => ['sometimes', Rule::in(['left', 'center', 'right'])],
            'pages.*.cover.hero_image_caption_placement' => ['sometimes', Rule::in(['overlay', 'below'])],
